...
set_property PACKAGE_PIN V3 [get_ports {Flag_Equal}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Flag_Equal}]
set_property PACKAGE_PIN W3 [get_ports {Flag_Greater}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Flag_Greater}]
set_property PACKAGE_PIN U3 [get_ports {Flag_Lesser}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Flag_Lesser}]
